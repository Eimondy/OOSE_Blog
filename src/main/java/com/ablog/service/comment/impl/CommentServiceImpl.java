 ...
 **/
package com.ablog.service.comment.impl;
...
import com.ablog.utils.DateKit;
...
public class CommentServiceImpl implements CommentService {
    ...
    @Override
    public List<Integer> getCommentsByUserId(Integer uid) {
        return commentDao.getCommentsByUserId(uid);
    }
}
